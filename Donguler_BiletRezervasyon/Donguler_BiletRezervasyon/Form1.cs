    ...
    public partial class Form1 : Form
    {
        ...
        private void KoltukYarat(int x, int y, bool koridorVarmi)
        {
            ...
            else
            {
                ...
                if (SoforKoltuguysa(x, y))
                    btn.Size = new System.Drawing.Size((koltukXSira / 2 * 60) - 10, 50);//(koltukXSira / 2 * 60) - 10
                else
        ...
        private bool Boslukmu(int x, int y)
        {
            if (
                    ...
                    || (!SoforKoltuguysa(x, y) && y == 0) // sofor koltugu degilse ve ilk y sırasındaysa
                )
            {
                return true;
            }
